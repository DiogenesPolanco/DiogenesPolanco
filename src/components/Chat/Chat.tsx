...
const responses: Record<string, string> = {
  ...
  contact: `You can find Diogenes at diogenes@polanco.com, GitHub (@DiogenesPolanco), Twitter (@diogenespolanco), or LinkedIn. Always open to new opportunities and interesting projects!`,
